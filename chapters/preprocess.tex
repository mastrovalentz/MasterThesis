...
In \tabref{4sicsdev} and \tabref{iotdev} the chosen device classes alongside with the device used for the creation of the dataset are reported. In the table the number of elements for each device of a specific class is also reported.
