...
The datasets introduced in \chapref{chap3} can not be in fact directly used for the training. These datasets are in fact save as \texttt{pcap} files, a format used to save the information about the traffic of a network, that can not be directly interfaced with a ANN, which requires as input a set of numeric values. 
