...
%\begin{minipage}{0.6\columnwidth}
    ...
    \tikzstyle{hidden neuron}=[neuron, fill=cobalt, minimum size=10pt];
	...
	% This is the same as writing \foreach \name / \y in {1/1,2/2,3/3,4/4}
		\node[input neuron, draw=black!100, thick, pin=left:{In{[}\#\y{]}: \( \boldsymbol{x_{\y}} \)}] (I-\name) at (-3.0*\layersep,\y) {};
