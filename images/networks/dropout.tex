...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50]
	...
	\draw[-stealth, double, dashed, draw=black!100, thick] (5.5,0) -- node[above] {dropout} (8.6, 0);
	...
	\node[red] (icr) at (i1) {$\times$}; 
	\node[red] (icr) at (i2){$\times$};
	...
	\node[red] (icr) at (h1){$\times$};
	\node[red] (icr) at (h3){$\times$};
	\node[red] (icr) at (h4){$\times$};
	...
	\node[red] (icr) at (hh2){$\times$};
	\node[red] (icr) at (hh4){$\times$};
